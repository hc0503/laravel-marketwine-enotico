...
@section('content') 
    ...
    {!! Form::open(['route'=>'pack.store','method'=>'post','files'=>true]) !!}
                        <div class="row">
                             <div class="col-lg-12">
                            <div class="form-group mb-3">
                                        <label for="example-palaceholder">Nombre del pack <span class="text-danger">*</span></label>
                                        {!! Form::text('nombre', null, ['class' => 'form-control' , 'placeholder' => 'Nombre del pack', 'required' => 'required']) !!}
                            </div>

                            <div class="form-group mb-3">
                                        <label for="example-palaceholder">Precio <span class="text-danger">*</span></label>
